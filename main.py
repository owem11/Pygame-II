...
intro = test_font.render('Press SPACE to start', False, (111,196,169))
intro_rect = intro.get_rect(center = (400,325))
game_name = test_font.render('Pygame Runner', False, 'white')
